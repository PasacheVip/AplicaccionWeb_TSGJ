    ...
    $.ajax({
        ...
        type: "GET",
        url: "../../Controlador/Utilidades/Notificaciones/Stock_Bajo/Notifi_Stock_Negativo.php",
        dataType: "json",
        ...
        success: function(response) {
            ...
            if (response.hasOwnProperty('idMessage')) {
                ...
                Swal.fire({
                    ...
                    text: '¡No cuenta con Stock Disponible!',
                    icon: 'error',
                    showConfirmButton: true,
                });

                // Mostrar los datos en la consola para verificar
                console.log("-> Producto: "+ producto +" no tiene stock disponible");

                // Realizar una nueva solicitud AJAX para ELIMINAR LA SESSION ID
                $.ajax({

                    type: "GET",
                    url: "../../Controlador/Utilidades/Notificaciones/Stock_Bajo/Delate_Notifi_Stock_Negativo.php",
